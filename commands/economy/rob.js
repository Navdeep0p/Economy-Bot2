  ...
  run: async (bot, message, args) => {
    ...
    if (author !== null && timeout - (Date.now() - author) > 0) {
      ...
      let moneyEmbed = new MessageEmbed()
        .setColor("GREEN")
        .setDescription(`❌ You need atleast 500 coins in your wallet to rob someone`);
      ...
      let moneyEmbed2 = new MessageEmbed()
        .setColor("GREEN")
        .setDescription(`❌ ${user.user.username} does not have atleast 500 coins to get robbed`);
